      ...
      <div className="container max-w-screen-2xl py-8 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2 font-playfair text-xl font-bold text-primary mb-4">
              <Icon name="Newspaper" className="h-6 w-6" />
              <span>НовостиОнлайн</span>
            </Link>
            <p className="text-sm text-muted-foreground mb-4">
              Оставайтесь в курсе последних событий с нашим информационным порталом.
              Актуальные новости, комментарии экспертов и аналитика.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/culture" className="text-muted-foreground hover:text-primary transition-colors">
                  Культура
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/submit-news" className="text-muted-foreground hover:text-primary transition-colors">
                  Предложить новость
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/comments" className="text-muted-foreground hover:text-primary transition-colors">
                  Комментарии
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-border/40 mt-8 pt-6 text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} НовостиОнлайн. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
